...
import {
    ...
    Image,
    Platform,
    NativeEventEmitter, NativeModules, DeviceEventEmitter, BackHandler,
} from 'react-native';

import AnylineOCR from 'anyline-ocr-react-native-module';

import NativeViewBarcodeConfig from '../../assets/anyline_assets/config/legacy/NativeViewBarcodeConfig.json';
import NativeViewDrivingLicenseConfig from '../../assets/anyline_assets/config/legacy/NativeViewDrivingLicenseConfig.json';
import NativeViewVINConfig from '../../assets/anyline_assets/config/legacy/NativeViewVINConfig.json';
