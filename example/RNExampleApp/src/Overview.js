...
export default function Overview({ openAnyline, checkCameraPermissionAndOpen, disabled }) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.buttons}>
        <Button style={styles.buttons} title={'  AT/DE/UK Driving License'} color="#0099FF"
          disabled={disabled}
          onPress={() => {
      ...
      <View style={styles.buttons}>
        <Button style={styles.buttons} title={'  NL Driving License'} color="#0099FF"
          disabled={disabled}
          onPress={() => {
            platformPermissionCheck('DRIVING_LICENSE_NL')
          }} />
      </View>

      <View style={styles.buttons}>
        <Button style={styles.buttons} title={'  BE Driving License'} color="#0099FF"
          disabled={disabled}
          onPress={() => {
            platformPermissionCheck('DRIVING_LICENSE_BE')
          }} />
      </View>
